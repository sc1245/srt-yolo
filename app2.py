...
if not os.path.exists('history'):
    os.makedirs('history')
model_map = {
    'FPH-CDet': '/mount/src/str-yolo/best.pt',
    'yolov7-tiny': '/mount/src/str-yolo/runs/detect/train2/weights/best.pt',
}
...
st.markdown(
    "<h1 style='text-align: center'><img width='50' src='https://picture.gptkong.com/20241114/1411fce2b0fd9942d582bd85472990b639.jpg'></img>在线检测平台</h1>",
    unsafe_allow_html=True)
with st.sidebar:
    ...
    selected = option_menu("功能列表", ["首页", "图片检测", "视频检测", "摄像头检测", "可视化模块","历史检测" ],
...
if selected == '首页':
    st.subheader("本平台是基于yolov7算法对图片、视频和摄像头三种输入实现对橘子进行检测，图片与视频检测功能支持文件上传或URL输入形式进行检测，每次检测的结果都可在历史检测中查看")
